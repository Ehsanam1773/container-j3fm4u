...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j3fm4u.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j3fm4u.containers.anotherwebservice.com/
...
```
git clone git@github.com:Ehsanam1773/container-j3fm4u.git
cd container-j3fm4u
```
...
```
docker attach container-j3fm4u
```
